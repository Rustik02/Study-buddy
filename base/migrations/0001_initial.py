    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('full_name', models.TextField(max_length=200, verbose_name='Full name')),
                ('avatar', models.ImageField(upload_to='user/avatar', verbose_name='Ava')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('topic', models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.SET_NULL, to='base.topic')),
            ],
            options={
